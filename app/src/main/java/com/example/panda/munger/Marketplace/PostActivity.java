...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_itempost);
    ...
    private void startPosting() {
        ...
        if (!TextUtils.isEmpty(title_val) && !TextUtils.isEmpty(location_val) &&
            ...
            newPost.child("price").setValue(location_val);
            newPost.child("location").setValue(datetime_val);
            newPost.child("description").setValue(description_val);

            startActivity(new Intent(PostActivity.this, ItemFeed.class ));
        }
